        ...
        if($user_role == 7){ //Done by Subham 08-01-2025 ?>
            <li class="nav-item has-submenu">
                <a class="nav-link" href="#">
                    <i class="fa fa-user-times" aria-hidden="true"></i>Unauthorised Occupant<i class="fa fa-angle-down fa-lg float-end mt-1" aria-hidden="true"></i>
                ...
                <ul class="submenu collapse">
                    <li class="nav-item">
                        <a href="<?= $base_root.$base_path.'view-unauthorised-occupants' ?>" class="nav-link ">
                            ...
                            System-Flagged Unauthorised Occupant
                        </a>
                    </li>
                </ul>
            </li>
