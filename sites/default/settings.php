...
/*  turned off by dg for this code not giving permission to login from another machine
...
ini_set('session.cookie_path', '/rhewbhousing'); // Set cookie path for the entire site
...
// $base_url = 'https://172.25.142.221/rhewbhousing';
// $base_url = 'https://172.25.142.221';
// $base_url = 'http://10.173.42.87/rhe_wb_gov_in';
//$base_url = 'http://localhost/rhe_wb_gov_in';
...
$conf['api_secret_token'] = 'WBHOUSING12#$';
